...
function renderProgression(env) {
	env.preventDefault();
...
function clearForm() {
	...
	const inputErrorsContainers = document.querySelectorAll(".error");

	for (const inputErrorsContainer of inputErrorsContainers) {
		inputErrorsContainer.classList.remove("error");
		inputErrorsContainer.parentElement.querySelector("p").remove();
	}
}
